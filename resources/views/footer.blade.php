    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <ul>
                    <li class="p-b-10">
                        <a href="http://127.0.0.1:8000/danh-muc/1-ao-thun.html" class="stext-107 cl7 hov-cl1 trans-04">
                            Áo thun
                        </a>
                    </li>

                    <li class="p-b-10">
                        <a href="http://127.0.0.1:8000/danh-muc/2-quan-tay.html" class="stext-107 cl7 hov-cl1 trans-04">
                            Quần tây
                        </a>
                    </li>
                </ul>
